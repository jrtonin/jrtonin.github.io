...
IV = price ~ hubling + aircraft + flight_hours + MMC + connection + X6.11 + X12.17 + X18.23 + RouteShare + 
  factor(Tourist) + factor(covid_wave) + factor(quarter) + factor(ArrHUB) + factor(capital_arr) + factor(position) + 
  factor(market) + factor(covid_leader) | . -RouteShare + m150RouteShare 
...
IV = price ~ hubling + aircraft + flight_hours + MMC + connection + X6.11 + X12.17 + X18.23 + 
  RouteShare | . -RouteShare + m150RouteShare 
