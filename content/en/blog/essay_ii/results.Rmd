...
# joining regression results
screenreg(list(gmm0 = GMM0, gmm1 = GMM1, gmm2 = GMM2, gmm3 = GMM3, gmm4 = GMM4),
               digits = 3, omit.coef = "(Intercept)")
...
GMM = price ~ lag(price) + hubling + aircraft + flight_hours + MMC +
  connection + X6.11 + X12.17 + X18.23 + RouteShare | llag(RouteShare, 1:2) + lag(price, 2:3) + m150RouteShare
...
# ec2sls
ecw1 = plm(IV, data = dLBASE2, model = "within")
