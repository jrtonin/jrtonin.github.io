...
nseats = BASE1 %>%
  ...
  select(covid_wave, single, var_1, duopoly, var_2, oligopoly, var_3, total, var_4) %>%
  mutate(across(everything(), ~ replace_na(., 0)),
         variable = "seats sold (share by market - in %")
...
ntakeoff = BASE1 %>%
  ...
  select(covid_wave, single, var_1, duopoly, var_2, oligopoly, var_3, total, var_4) %>%
  mutate(across(everything(), ~ replace_na(., 0)),
         variable = "Takeoffs (share by market - in %") 
...
ndistance = BASE1 %>%
  ...
  select(covid_wave, single, var_1, duopoly, var_2, oligopoly, var_3, total, var_4) %>%
  mutate(across(everything(), ~ replace_na(., 0)),
         variable = "Average distance (in km)") 
