...
### What is the Brazillian airline market estructure?

```{r airline_market, include=FALSE, echo=TRUE}
...
```{r sd_full_duopoly, include=TRUE, echo=FALSE}
...
sdfulla = BASE1 %>% ungroup() %>%
  ...
  do(tidy(t.test(.$lider, 
                 .$seguidora, 
                 alt = "two.sided", 
                 paired = TRUE)))
  

t.test(value ~ market, data = sdfulla, paired = TRUE)
